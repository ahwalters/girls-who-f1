...
export default function AboutF1() {
    ...
    return (
    <div className="w3-row-padding w3-light-grey w3-padding-32 w3-container">
      <div className="w3-content">
        <div className="w3-third w3-center">
          <img className="fa fa-coffee w3-padding-64 w3-margin-right" src={require("../Assets/Screens.jpg")} width="275"/>
        </div>
